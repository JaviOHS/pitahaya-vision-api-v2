...
class AnalysisResult(models.Model):
    # conversation = models.ForeignKey(Conversation, on_delete=models.SET_NULL, null=True, blank=True, related_name='analysis_results')
    # chat_message = models.ForeignKey(ChatMessage, on_delete=models.SET_NULL, null=True, blank=True, related_name='analysis_results')
    ...
    recommendation_text = models.TextField(default='', blank=True)
